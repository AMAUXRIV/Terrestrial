...
```json
{
    ...
    "data": [
        ...
        {
            "id": 4,
            "queText": "Dari Piliihan Di Bawah Ini, Kamu Lebih Suka Melakukan yang Mana?"
        },
        {
            "id": 5,
...
{
  "questionId": 8,
  "answerText": "Saya tertarik untuk membangun solusi yang inovatif dan memberikan dampak positif pada pengguna."
}
```
